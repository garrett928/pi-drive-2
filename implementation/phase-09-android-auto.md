...
- `/pd-screenshot` (of DHU window or phone)
...
- `/pd-screenshot` of graphs screen
...
- `/pd-screenshot` -> 1/3 panel with hero readout visible
- Switch to Page 2 -> 6 metric tiles visible
